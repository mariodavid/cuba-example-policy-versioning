...
public class CepvTestContainer extends TestContainer {

    public CepvTestContainer() {
        super();
    ...
    public static class Common extends CepvTestContainer {

        public static final CepvTestContainer.Common INSTANCE = new CepvTestContainer.Common();
